...
DEFINES = ['NS3_BUILD_PROFILE_OPTIMIZED', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_SQLITE3=1', 'HAVE_IF_TUN_H=1']
...
EXAMPLE_DIRECTORIES = ['tutorial', 'realtime', 'traffic-control', 'wireless', 'tcp', 'error-model', 'socket', 'stats', 'udp', 'ipv6', 'routing', 'matrix-topology', 'naming', 'energy', 'udp-client-server']
...
VALGRIND_FOUND = True
VERSION = '3.29'
WITH_PYBINDGEN = '/home/george/ns-3/pybindgen-0.17.0.post58+ngcf00cc0'
