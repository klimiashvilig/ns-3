...
#ifndef LORA_ENERGY_MODEL_HELPER_H
#define LORA_ENERGY_MODEL_HELPER_H

#include "ns3/energy-model-helper.h"
#include "ns3/lora-energy-model.h"

namespace ns3 {

/**
 * \ingroup energy
 * \brief Assign LoraEnergyModel to Lora devices.
 *
 * This installer installs LoraEnergyModel for only LoraNetDevice objects.
 *
 */
class LoraEnergyModelHelper : public DeviceEnergyModelHelper
{
public:
  /**
   * Construct a helper which is used to add a radio energy model to a node
   */
  LoraEnergyModelHelper ();
...
private:
  ...
  LoraEnergyModel::LoraEnergyDepletionCallback m_depletionCallback; ///< radio energy depletion callback
  LoraEnergyModel::LoraEnergyRechargedCallback m_rechargedCallback; ///< radio energy recharged callback
