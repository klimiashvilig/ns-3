...
>>>>>>> 913abe7e3d53a6fc4d574970246f199c3384512c
...
<<<<<<< HEAD
std::string fileName = "wifiresults-" + std::to_string(fileSize) + "B-3flows.txt";
...
<<<<<<< HEAD
    ...
    for (int runNum = (variableRunNum ? 6:defaultRunNum); runNum <= (variableRunNum ? 30:defaultRunNum); runNum++) {
=======
