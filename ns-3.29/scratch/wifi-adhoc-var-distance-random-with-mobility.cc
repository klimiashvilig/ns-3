...
std::string fileName = "wifiresults-" + std::to_string(fileSize) + "B-1flow-with-mobility" + (routing ? "" : "-nr") + ".txt";
...
int main(int argc, char * argv[]) {
  ...
  fileName = "wifiresults-" + std::to_string(fileSize) + "B-1flow-with-mobility" + (routing ? "" : "-nr") + ".txt";
