...
void getEnergy() {
  ...
  Simulator::Schedule(Seconds(1), & getEnergy);
}
...
int main(int argc, char * argv[]) {
  ...
  Address sinkAddress (InetSocketAddress (i[numNodes - 2].GetAddress(1), sinkPort)); // interface of n24
  ...
  sinkApps.Stop (Seconds (numPackets));
  ...
  Simulator::Stop (Seconds (numPackets + 5));
  Simulator::Run();
  Simulator::Destroy();
