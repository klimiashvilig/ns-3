                      ...
                      double frequencyMHz, double txPowerDbm)
{
  ...
  NS_LOG_UNCOND("Duration: " << duration.GetSeconds());
  NS_LOG_UNCOND("Frequency: " << frequencyMHz);
                              ...
                              uint8_t sf, Time duration, double frequencyMHz)
{
  ...
  //NS_LOG_UNCOND("duraiton: " << duration.GetSeconds() << " simulation time: " << Simulator::Now ().GetSeconds () << "s");
  dur = duration.GetSeconds();
  ...
  if (packetDestroyed != uint8_t (0))
    {
      ...
      SwitchHelperFromRxEndError(packet);
  ...
  else   // Reception was correct
    {
      ...
      SwitchHelperFromRxEndOk(packet);
...
int
GatewayLoraPhy::getDuration(void) {
  return dur;
}

void
GatewayLoraPhy::SwitchHelperToTx(Time txDuration, double txPowerDbm)
{
  LoraPhy::GetStateHelper()->SwitchToTx(txDuration, txPowerDbm);
}

void
GatewayLoraPhy::SwitchHelperToRx(Time rxDuration)
{
  LoraPhy::GetStateHelper()->SwitchToRx(rxDuration);
}

void
GatewayLoraPhy::SwitchHelperFromRxEndOk(Ptr<Packet> packet)
{
  LoraPhy::GetStateHelper()->SwitchFromRxEndOk(packet);
}

void
GatewayLoraPhy::SwitchHelperFromRxEndError(Ptr<Packet> packet)
{
  LoraPhy::GetStateHelper()->SwitchFromRxEndError(packet);
}

void
GatewayLoraPhy::SwitchHelperToSleep(void)
{
  LoraPhy::GetStateHelper()->SwitchToSleep();
}

void
GatewayLoraPhy::SwitchHelperFromSleep(Time duration)
{
