...
The module provides a very simple mesh-under routing, implemented as a flooding.
...
At node level, each packet is re-breadcasted if its BC0 Sequence Number is not in the cache of the
